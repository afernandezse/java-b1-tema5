 ...
 * --------------------------------------------------------------------
 * Una empresa tecnológica gestiona una plataforma online con múltiples
 * formularios
 * (registro, encuestas, feedback, etc.). Para analizar las respuestas
 * introducidas por
 * los usuarios, el equipo de desarrollo quiere crear una clase llamada
 * FormUtils con
 ...
 * ---------------------------------------------------------------
 * Una empresa tecnològica gestiona una plataforma en línia amb diversos
 * formularis
 * (registre, enquestes, valoració, etc.). Per analitzar les respostes
 * introduïdes pels
 * usuaris, l’equip de desenvolupament vol crear una classe anomenada FormUtils
 * amb
