 ...
 * ---------------------------------------------
 * Una empresa tecnológica desea construir un sistema interno de registro de
 * eventos
 ...
 *
 * Se proporciona una clase genérica llamada EventLogger<T>, que puede ser
 * instanciada
 * para registrar eventos de cualquier tipo. Sin embargo, cada instancia
 * almacenará únicamente
 * eventos de un tipo específico.
 * Por ejemplo, una instancia de EventLogger<UserLogin> almacenará
 * exclusivamente objetos de tipo
 * UserLogin, mientras que una instancia de EventLogger<SystemError> contendrá
 * solo eventos del tipo SystemError.
 * Esto permite reutilizar la misma estructura de registro (EventLogger) para
 ...
 * - BankTransaction: contiene tipo (String: ingreso o retiro) y cantidad
 * (double).
 ...
 * --------------------------------------------------
 * Una empresa tecnològica vol construir un sistema intern de registre
 * d'esdeveniments
 ...
 *
 * Es proporciona una classe genèrica anomenada EventLogger<T>, que pot ser
 * instanciada
 * per registrar esdeveniments de qualsevol tipus. Tot i això, cada instància
 * emmagatzemarà únicament
 * esdeveniments d'un tipus específic.
 * Per exemple, una instància d'EventLogger<UserLogin> emmagatzemarà
 * exclusivament objectes de tipus
 * UserLogin, mentre que una instància de EventLogger<SystemError> contindrà
 * només esdeveniments del tipus SystemError.
 * Això permet reutilitzar la mateixa estructura de registre (EventLogger) per a
 * diferents tipus d'esdeveniments,
 * sense barrejar tipus dins d'una mateixa instància. Aquesta classe ha de
 * permetre:
 *
 ...
 * - BankTransaction: conté tipus (String: ingrés o reintegrament) i quantitat
 * (double).
 ...
 *
 * - List<T> getAllEvents()
 * Retorna una llista amb tots els esdeveniments registrats, en ordre
 * d'inserció.
 *
 * EXEMPLE:
 * --------
